    ...
    config = {
        ...
        "settings": {
            ...
            "live_rank": {
                ...
                "device": "desktop",
                "note": "URL of the live-rank Worker (see serverless/README.md). Empty = the Live Google Rank column stays inactive. The dashboard only requests live ranks for rows currently on screen; the Worker caches and enforces a daily budget cap.",
            },
            "country": "sgp",
